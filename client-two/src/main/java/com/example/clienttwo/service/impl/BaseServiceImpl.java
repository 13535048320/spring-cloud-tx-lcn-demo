...
import com.example.clienttwo.service.IBaseService;
...
public abstract class BaseServiceImpl<T> implements IBaseService<T> {
	...
	@Transactional(readOnly = true)
	@Override
	public List<T> selectByExample(Object example, Integer pageNum, Integer pageSize) {
		//只生效一次。做两次sql查询，总数查询一次，分页查询一次
